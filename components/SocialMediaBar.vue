<template>
  <div v-if="isDesktop" class="social-media-bar">
    <!-- Facebook -->
    <a 
      href="https://www.facebook.com/artilora" 
      target="_blank" 
    ...
    <!-- Instagram -->
    <a 
      href="https://www.instagram.com/artilora" 
      target="_blank" 
      rel="noopener noreferrer"
    ...
    <!-- Twitter/X -->
    <a 
      href="https://twitter.com/artilora" 
      target="_blank" 
      rel="noopener noreferrer"
    ...
    <!-- LinkedIn -->
    <a 
      href="https://www.linkedin.com/company/artilora" 
      target="_blank" 
      rel="noopener noreferrer"
    ...
    <!-- YouTube -->
    <a 
      href="https://www.youtube.com/@artilora" 
      target="_blank" 
      rel="noopener noreferrer"
